      ...
      <div className="max-w-6xl mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="text-center mb-3 sm:mb-4 md:mb-6 lg:mb-3 xl:mb-4 2xl:mb-6">
          ...
          <div className="mt-3 sm:mt-4 md:mt-6 flex justify-center">
            <div className="bg-brand-500 h-1.5 sm:h-2 md:h-2.5 rounded-full w-full max-w-md xl:max-w-lg">
              <div
                className="bg-brand-600 h-1.5 sm:h-2 md:h-2.5 rounded-full transition-all duration-300"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden overflow-y-auto flex-1 flex flex-col min-h-0">
          ...
          <div className="border-t border-gray-200 dark:border-gray-600 p-3 sm:p-4 md:p-6 lg:p-3 xl:p-4 2xl:p-6 flex justify-end">
            <Button
              ...
              className="text-sm sm:text-base md:text-lg px-4 sm:px-6 py-2 sm:py-3 md:py-4"
            >
