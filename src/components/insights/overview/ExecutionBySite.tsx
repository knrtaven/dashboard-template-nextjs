...
const ExecutionBySite = () => {
  ...
  const seriesData = [47, 42, 49, 45, 41, 48, 43, 46, 50, 44];
  ...
  return (
    <div className="h-full w-full shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      <div className="flex flex-col px-6 py-8">
        ...
        <h2 className="text-lg font-medium dark:text-white">Execution by Site Jun-25</h2>
...
export default ExecutionBySite;
