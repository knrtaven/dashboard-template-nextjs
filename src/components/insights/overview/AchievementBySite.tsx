...
const AchievementBySite = () => {
  ...
  const seriesData = [73, 78, 71, 76, 79, 72, 75, 80, 74, 77];
  ...
  return (
    <div className="h-full w-full shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      <div className="flex flex-col px-6 py-8">
        ...
        <h2 className="text-lg font-medium dark:text-white">Achievement by Site Jun-25</h2>
...
export default AchievementBySite;
