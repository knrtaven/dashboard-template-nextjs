...
const COURSE_MODULES_DATA: { [key: number]: CourseContent } = {
  ...
  1: {
    ...
    modules: [
      {
        id: 1,
        title: 'Assess Your Personal Wellbeing',
        description:
          "Take a moment to reflect on how you're really doing—physically, emotionally, and mentally. This lesson helps you identify early signs of imbalance and create a personal wellbeing snapshot.",
        isCompleted: false,
        isLocked: false,
        order: 1,
      },
      {
        id: 2,
        title: 'How Stress Affects You',
        description:
          'Stress shows up in many ways—sometimes physically, sometimes emotionally. We&apos;ll explore how it affects your body, thoughts, and daily habits without you even realising it.',
        isCompleted: false,
        isLocked: false,
        order: 2,
      },
      {
        ...
        description:
          'Workplace stress doesn&apos;t just affect individuals—it can ripple through entire teams and impact performance. This lesson unpacks the common causes and how stress silently chips away at workplace culture.',
        isCompleted: false,
        isLocked: false,
        order: 3,
      },
      {
        ...
        description:
          'Learn simple, practical ways to bring more calm and control into your workday. From time management to mindset shifts, this lesson gives you tools to better manage pressure.',
        isCompleted: false,
        isLocked: false,
        order: 4,
      },
...
export const getIncompleteWorkRiteModules = (): {
  courseId: number;
  modules: ModuleData[];
  courseName?: string;
}[] => {
...
export const getIncompleteLeadRiteModules = (): {
  courseId: number;
  modules: ModuleData[];
  courseName?: string;
}[] => {
